...
const trackedVesselISMSchema = new mongoose.Schema({
...
const TrackedVesselISM = mongoose.model('vesselstrackeds_ISM', trackedVesselISMSchema , 'vesselstrackeds_ISM');


// Export the model
export default  TrackedVesselISM ;
