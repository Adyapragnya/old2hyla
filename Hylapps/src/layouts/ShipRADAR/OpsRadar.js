...
// 2. Define a storage key:
const LOCAL_STORAGE_KEY = 'opsRadarTableState';
...
// 4. Create a debounced save function:
...
// 5. Wrap state updates so they persist:
    ...
    <div className="geofence-histories">
      {dataSource.length === 0 ? (
        ...
        <MaterialReactTable
          ...
          enableDensityToggle
          enableRowActions
          state={tableState} //this is very improtant for saving method
          onStateChange={handleStateChange} //this is very improtant for saving method
